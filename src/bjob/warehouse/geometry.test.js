...
import { connectWalls, rectangleFromDrag, rectangleWalls, segmentsIntersect, snapPoint, validateWalls } from './geometry.js';

describe('warehouse geometry', () => {
  it('creates four walls from a rectangle', () => {
  ...
  it('detects connected walls', () => {
    const walls = rectangleWalls({ x: 0, y: 0, width: 100, height: 100 }).map((wall, i) => ({ ...wall, id: `w${i}` }));
